...
#define AC3_WORD_SIZE 2
  ...
  /* Sample rate codes :*/
#define AC3_SAMPLERATE_48000 0x0
#define AC3_SAMPLERATE_44100 0x1
#define AC3_SAMPLERATE_32000 0x2

  /* AC3 CRC parameters */
#define AC3_CRC_LENGTH 16
#define AC3_CRC_POLY 0x18005
#define AC3_CRC_MODULO 0x10000

#define AC3_CRC_PARAMS                                                        \
  (CrcParam) {AC3_CRC_LENGTH, AC3_CRC_POLY, AC3_CRC_TABLE, 0}

  /* AC3 DescriptorPtr parameters */
#define EXACT_BITRATE 0
#define LIMIT_BITRATE 1

#define BITRATE_MODE EXACT_BITRATE

#define MINIMAL_ALLOWED_BITRATE 96

#define FULL_SERVICE 0
...
#define TRUE_HD_SYNCWORD  ((MLP_SYNCWORD_PREFIX << 8) | TRUE_HD_SYNCWORD_SUFFIX)
#define MLP_SYNCWORD  ((MLP_SYNCWORD_PREFIX << 8) | MLP_SYNCWORD_SUFFIX)

#define TRUE_HD_SIGNATURE            0xB752

#define TRUE_HD_MAX_AUTHORIZED_BITRATE 18*1000000 /* 18 * 10**6 bits/s */
#define TRUE_HD_MAX_AUTHORIZED_EXT_SS_NB 4
#define TRUE_HD_MAX_AUTHORIZED_16CH_CHANNEL_COUNT 15

  /* TrueHD CRC parameters */
#define TRUE_HD_MINOR_SYNC_CHECK_NIBBLE_ENDVALUE 0xF

#define TRUE_HD_MAJOR_SYNC_CRC_LENGTH      16
#define TRUE_HD_MAJOR_SYNC_CRC_POLY   0x1002D
#define TRUE_HD_MAJOR_SYNC_CRC_MODULO 0x10000

#define TRUE_HD_MAJOR_SYNC_CRC_PARAMS                                         \
  (CrcParam) {                                                                \
    TRUE_HD_MAJOR_SYNC_CRC_LENGTH, TRUE_HD_MAJOR_SYNC_CRC_POLY,               \
    NO_CRC_TABLE, 1                                                           \
  }

  /* TrueHD Channels Assignment values : */
#define MLP_CHANNELS_L_R             0x0001
#define MLP_CHANNELS_C               0x0002
#define MLP_CHANNELS_LFE             0x0004
#define MLP_CHANNELS_LS_LR           0x0008
#define MLP_CHANNELS_TFL_TFR         0x0010
#define MLP_CHANNELS_LSC_RSC         0x0020
#define MLP_CHANNELS_LB_RB           0x0040
#define MLP_CHANNELS_CB              0x0080
#define MLP_CHANNELS_TC              0x0100
#define MLP_CHANNELS_LSD_RSD         0x0200
#define MLP_CHANNELS_LW_RW           0x0400
#define MLP_CHANNELS_TFC             0x0800
#define MLP_CHANNELS_LFE2            0x1000
#define MLP_ALTER_CHANNELS_TSL_TSR   0x0010

#define MLP_CHANNELS_L_R_NB               2
#define MLP_CHANNELS_C_NB                 1
#define MLP_CHANNELS_LFE_NB               1
#define MLP_CHANNELS_LS_LR_NB             2
#define MLP_CHANNELS_TFL_TFR_NB           2
#define MLP_CHANNELS_LSC_RSC_NB           2
#define MLP_CHANNELS_LB_RB_NB             2
#define MLP_CHANNELS_CB_NB                1
#define MLP_CHANNELS_TC_NB                1
#define MLP_CHANNELS_LSD_RSD_NB           2
#define MLP_CHANNELS_LW_RW_NB             2
#define MLP_CHANNELS_TFC_NB               1
#define MLP_CHANNELS_LFE2_NB              1
#define MLP_ALTER_CHANNELS_TSL_TSR_NB     2
...
static inline void applyNibbleXorMlp(
  uint8_t * buf,
  uint32_t value,
  size_t size
)
{
  assert(NULL != buf);
  assert(size <= 32 && 0 == (size % 4)); /* Size must be between 0-32 and a multiple of 4. */
...
typedef struct {
  ...
  unsigned sampleRate;
  int u6ch_presentation_channel_nb;
  int u8ch_presentation_channel_nb;
...
typedef struct {
  ...
  MlpextSubstream extSubstreams[TRUE_HD_MAX_AUTHORIZED_EXT_SS_NB];

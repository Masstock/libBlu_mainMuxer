...
#ifndef CWK_WCHAR_LIBRARY_H
#define CWK_WCHAR_LIBRARY_H
 ...
 * segment or not.
 *
 * CWKW_NORMAL - normal folder or file segment
 * CWKW_CURRENT - "./" current folder segment
 * CWKW_BACK - "../" relative back navigation segment
 */
enum cwkw_segment_type
{
  CWKW_NORMAL,
  CWKW_CURRENT,
  CWKW_BACK
 ...
 */
CWK_PUBLIC size_t cwkw_path_get_absolute(const wchar_t *base, const wchar_t *path,
 ...
 */
CWK_PUBLIC size_t cwkw_path_get_relative(const wchar_t *base_directory,
  const wchar_t *path, wchar_t *buffer, size_t buffer_size);

/**
 * @brief Joins two paths together.
 *
 * This function generates a new path by combining the two submitted paths. It
 * will remove double separators, and unlike cwkw_path_get_absolute it permits
 ...
 */
CWK_PUBLIC size_t cwkw_path_join(const wchar_t *path_a, const wchar_t *path_b,
  wchar_t *buffer, size_t buffer_size);
 ...
 * @return Returns the total amount of characters of the full, combined path.
 */
CWK_PUBLIC size_t cwkw_path_join_multiple(const wchar_t **paths, wchar_t *buffer,
  size_t buffer_size);
 ...
 */
CWK_PUBLIC void cwkw_path_get_root(const wchar_t *path, size_t *length);
 ...
 */
CWK_PUBLIC size_t cwkw_path_change_root(const wchar_t *path, const wchar_t *new_root,
  wchar_t *buffer, size_t buffer_size);
 ...
 */
CWK_PUBLIC bool cwkw_path_is_absolute(const wchar_t *path);
 ...
 */
CWK_PUBLIC bool cwkw_path_is_relative(const wchar_t *path);
 ...
 */
CWK_PUBLIC void cwkw_path_get_basename(const wchar_t *path, const wchar_t **basename,
  size_t *length);
 ...
 * not truncated.
 */
CWK_PUBLIC size_t cwkw_path_change_basename(const wchar_t *path,
  const wchar_t *new_basename, wchar_t *buffer, size_t buffer_size);
 ...
 */
CWK_PUBLIC void cwkw_path_get_dirname(const wchar_t *path, size_t *length);
 ...
 */
CWK_PUBLIC bool cwkw_path_get_extension(const wchar_t *path, const wchar_t **extension,
  size_t *length);
 ...
 */
CWK_PUBLIC bool cwkw_path_has_extension(const wchar_t *path);
 ...
 * truncated.
 */
CWK_PUBLIC size_t cwkw_path_change_extension(const wchar_t *path,
  const wchar_t *new_extension, wchar_t *buffer, size_t buffer_size);
 ...
 * truncated.
 */
CWK_PUBLIC size_t cwkw_path_normalize(const wchar_t *path, wchar_t *buffer,
  size_t buffer_size);
 ...
 */
CWK_PUBLIC size_t cwkw_path_get_intersection(const wchar_t *path_base,
  const wchar_t *path_other);
 ...
 */
CWK_PUBLIC bool cwkw_path_get_first_segment(const wchar_t *path,
 ...
 * @return Returns true if there is a segment or false if there is none.
 */
CWK_PUBLIC bool cwkw_path_get_last_segment(const wchar_t *path,
  struct cwkw_segment *segment);
 ...
 */
CWK_PUBLIC bool cwkw_path_get_next_segment(struct cwkw_segment *segment);
 ...
 * otherwise.
 */
CWK_PUBLIC bool cwkw_path_get_previous_segment(struct cwkw_segment *segment);
 ...
 */
CWK_PUBLIC enum cwkw_segment_type cwkw_path_get_segment_type(
 ...
 * was not truncated.
 */
CWK_PUBLIC size_t cwkw_path_change_segment(struct cwkw_segment *segment,
  const wchar_t *value, wchar_t *buffer, size_t buffer_size);
 ...
 */
CWK_PUBLIC bool cwkw_path_is_separator(const wchar_t *str);
 ...
 */
CWK_PUBLIC enum cwkw_path_style  cwkw_path_guess_style(const wchar_t *path);
 ...
 */
CWK_PUBLIC void cwkw_path_set_style(enum cwkw_path_style  style);
 ...
 */
CWK_PUBLIC enum cwkw_path_style  cwkw_path_get_style(void);
